...
const InvoiceTab = props => {
	...
	console.log("InvoiceTab props ", props)
				...
				<Card className="w-xl mx-auto shadow-0">
					<CardContent className="p-88 print:p-0">
						...
						<div className="flex justify-between">
							...
							{/*	<img className="w-80" src="assets/images/logos/logo.jpg" alt="logo" />*/}
						...
						<div className="mt-96">
							...
							<div className="flex">
								<div className="flex-shrink-0">
									{/*<img className="w-32" src="assets/images/logos/logo.jpg" alt="logo" />*/}
								</div>
